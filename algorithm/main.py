...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='CIFAR10', choices=['CIFAR10', 'CIFAR100', 'DVSGesture', 'CIFAR10DVS', 'TINYIMAGENET'],
    ...
    parser.add_argument('--avoid-wn', action='store_true',
                        help='Avoid weight normalization')
    parser.add_argument('--low-precision-training', action='store_true',
                        help='Use low precision training')
    parser.add_argument('--forward-intx', type=int, default=8,
                        help='Training bit-width in the forward pass')
